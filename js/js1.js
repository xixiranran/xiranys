...
(function () {
    ...
    //   部分或全部代码创建作品。
    // * 杀佛观音赋予用户举报权利，若发现第三方侵权行
    //   为，无需联系作者本人，可直接发起举报。

    //声明
    //本项目脚本非商业化、非盈利，即无广告、无优惠券内容、无公众号限制、无任何收益。因此，不会保证预留的解析网站列表随时可用，亦不会高强度更新解析网站列表。解析网站可能随时失效，无法观看时自行寻找接口并在源码内更改解析网站列表，无资源并非脚本问题，是否存在资源也与脚本基础功能（跳转页面）毫无联系。
    //历经数次代码抄袭事件，我们决定本项目脚本已存功能只修复异常不再健壮升级、便捷性优化或其他功能开发计划长期搁置，即增加内嵌解析功能的原计划无限期推迟；更健壮的去广告奇技淫巧与更高强度（原站蓝光直链）的解析网站不予公开。
    //极简版基本满足用户需求，虽然没有内嵌解析功能，但已足够；若您对观看体验有着极高的追求，可申请升级至“杀佛观音·全网VIP视频解析·完全版”，真正意义上的天花板，详细功能说明见下方脚本下载地址信息页。
    ...
    var KillBuddha_jiexi = [
        {name:'(b)gai4',src:'https://www.gai4.com/?url=',},
        {name:'(b)mtosz',src:'https://www.mtosz.com/m3u8.php?url=',},
        {name:'(b)nxflv',src:'https://www.nxflv.com/?url=',},
        {name:'(b)okjx',src:'https://okjx.cc/?url=',},
        {name:'(b)parwix',src:'https://jx.parwix.com:4433/player/analysis.php?v=',},
        {name:'(b)playerjy',src:'https://jx.playerjy.com/?url=',},
        {name:'(b)qianqi',src:'https://api.qianqi.net/vip/?url=',},
        {name:'(b)yemu',src:'https://www.yemu.xyz/?url=',},
        {name:'(bs)m1907',src:'https://z1.m1907.cn/?jx=',},
        ...
        {name:'(s)vercel',src:'https://thinkibm.vercel.app/?url=',},
        {name:'5gseo',src:'https://sb.5gseo.net/?url=',},
        {name:'973973',src:'https://jx.973973.xyz/?url=',},
        {name:'blbo',src:'https://jx.blbo.cc:4433/?url=',},
        {name:'h8jx',src:'https://www.h8jx.com/jiexi.php?url=',},
        {name:'lecurl',src:'https://lecurl.cn/?url=',},
        {name:'m3u8',src:'https://jx.m3u8.tv/jiexi/?url=',},
        {name:'xmflv',src:'https://jx.xmflv.com/?url=',},
        {name:'yh0523',src:'https://go.yh0523.cn/y.cy?url=',},
    ];
    ...
    case 'tv.sohu.com':
        (function() {
            ...
            setInterval(function (){
                ...
                if (document.querySelector('.x-adv-select-panel') && document.querySelector('.x-adv-select-panel').style.display !== 'none' && document.querySelector('shpdiv.x-adv-select-container > shpdiv:nth-child(2) > shpdiv.select_button')) {
                    document.querySelector('shpdiv.x-adv-select-container > shpdiv:nth-child(2) > shpdiv.select_button').click();
                }
