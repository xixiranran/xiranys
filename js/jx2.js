			...
			if (location.href.match(/\.163\..+?\/store/)) {} else {
				try {
					...
					function jxbvipobj() {
												...
												if (Math.floor(elevideo.duration - elevideo.currentTime) <= 15) {
													try {
														if (objj.match(/\.youku\./)) {
															...
															location.href = document.querySelector('[_wind*="选集"]>span[class="item current"]').nextElementSibling.getElementsByTagName('a')[0].href;
														} else {}
													} catch (e) {}
												}
											} catch (e) {}
						...
						const jxbvipjxstyle = 'style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;"', jxbvipjximg = 'marginwidth="0" marginheight="0" width="100%" height="100%" ' + jxbvipjxstyle, jxbvipjxidstyle = 'style="width:100%;height:100%;border:none;outline:none;margin:0;padding:0;position:absolute;z-index:963540817;background-color:black;display:flex;justify-content:center;align-items:center;flex-direction:column;font-size:xx-large;"', jxbvipjxstrongstyle = 'font-weight:bold;display:flex;justify-content:space-evenly;align-items:center;width:100%;max-width:50%;"', jxbvipjxyyy = '<div id="江小白" ' + jxbvipjxidstyle + '><div style="letter-spacing:2px;color:#f8964c;' + jxbvipjxstrongstyle + '><strong>江</strong><strong>小</strong><strong>白</strong></div><iframe id="江小白" data-ad="false" autoLoad="true" autoplay="autoplay" loading="lazy" allowtransparency="true" frameborder="0" scrolling="no" security="restricted" sandbox="allow-top-navigation allow-same-origin allow-forms allow-scripts" allowfullscreen="allowfullscreen" mozallowfullscreen="mozallowfullscreen" msallowfullscreen="msallowfullscreen" oallowfullscreen="oallowfullscreen" webkitallowfullscreen="webkitallowfullscreen" src="', jxbvipjxvideoa = '<video id="江小白" controls="controls" autoplay="autoplay" name="media" style="width:100%;height:100%;background:black;"><source src="', jxbvipjxvideob = '" type="video/mp4"></video>';
						function jxqzsxobj() {
							try {
						...
						if (iqiyialiwaiobj) {} else if (pcliwaiobj || sjliwaiobj || jxjkobj || mmkjjtjobj || objj.match(/(?:isyour|miao101|douyin|kuaishou|douban|bilibili|acfun|douban|yinyuetai|kuwo|kugou|m1907|qq|xiami|migu|ximalaya|app-echo|1ting|lrts|haokan|baidu|wbdy|web3v|9ku)\./)) {
							cssobj('[class*="_ad_more"],[id*="_ad_more"],[class*="pp"][class*="anner"],[id*="pp"][id*="anner"],[dt-eid*="pen"][dt-eid*="anner"]');
							...
							if (objj.match(/(?:jx\.2bjx\.com|4321s\.cc|xjqxz\.top)/)) {
								...
								try {
									(function() {
										if (!document.querySelector("\u6c5f\u5c0f\u767d\u76d1\u63a7\u89c6\u9891\u64ad\u653e\u7ed3\u675f")) {
											if (objj.match(/(?:m1907\.|jx\.2bjx\.com|4321s\.cc|xjqxz\.top)/)) {} else {
						...
						async function zdbt() {
							...
							setTimeout(() => {
								if (document.querySelector("\u6c5f\u5c0f\u767d\u81ea\u5b9a\u4e49\u63a5\u53e3") != null) {} else {
									...
									if (localStorage.getItem("objjbo") == '1') {
										if (document.querySelector("\u6c5f\u5c0f\u767d\u7535\u8111\u7f51\u9875") != null) {
											ccc = '<span><a1 style="color:darkgreen">搜索</a1><a2 style="display:none">', fff = '<span style="text-shadow:rgba(0, 0, 0, 0.8) -1px -1px 1px;border-bottom-color:rgba(0, 0, 0, 0.35);background-position:initial;background-size:initial;background-repeat:initial;background-attachment:initial;background-origin:initial;background-clip:initial;background-color:cyan;cursor:pointer;"><a1 style="display:none;">小窗</a1><a2 style="display:none">', ggg = '</a2><a3 style="display:none"></a3><a4>', ee = '<span style="text-shadow:-1px -1px 1px rgba(0, 0, 0, 0.8);border-bottom-color:rgba(0, 0, 0, 0.35);background: hsl(260, 81%, 63%);cursor:pointer;"><a1 style="display:none;"></a1><a2 style="display:none">';
										} else {
									...
									httpsaobj = [{
										...
										name: "金鸡",
										url: "https%3A%2F%2Fjjxx.me%2F%3Furl%3D"
									}, {
										name: "达人",
									...
									httpsbobj = [{
										...
										name: "沐白",
										url: "https%3A%2F%2Fwww.miede.top%2F%3Furl%3D",
										vip: "强制弹大窗"
									}, {
										name: "爱酷",
															...
															try {
																			...
																			if (jxb.match(new RegExp("^https:\/\/(?!.+?强制(?:弹[小大]窗|跳转|搜索))")) && !(jxb.match(new RegExp("(?:透明无接口|布米米|视频选集|米侠|Youtube|麻花影视|旋风视频)")))) {
																				...
																				if (jxb.match(new RegExp("透明无接口"))) {
																						...
																						try {
																							try {
																								if (atob(https[num].url).match(/%s/i)) {
																									...
																									window.open(atob(https[num].url) + sessionStorage.getItem('搜索关键词'), "_blank");
																								}
																							} catch (err) {
																								if (unescape(https[num].url).match(/%s/i)) {
																									window.open(unescape(https[num].url).replace(/%s/i, sessionStorage.getItem('搜索关键词')), "_blank");
																								} else {
																									window.open(unescape(https[num].url) + sessionStorage.getItem('搜索关键词'), "_blank");
																								}
																							}
																						} catch (err) {}
																					}, 123);
																					...
																					setTimeout(function() {
																						...
																						try {
																							window.open('http://www.bumimi99.com/search/' + sessionStorage.getItem('搜索关键词'), '_blank');
																						} catch (err) {}
																					}, 123);
																					...
																					setTimeout(function() {
																						...
																						try {
																							window.open('http://www.wbdy.tv/index.php?m=vod-search&wd=' + sessionStorage.getItem('搜索关键词'), '_blank');
																						} catch (err) {}
																					}, 123);
																					...
																					setTimeout(function() {
																						try {
																							if (document.title.match(/第\s*?\d+?\s*?[集话]/) != null) {
																								...
																								window.open('https://www.youtube.com/results?search_query=' + sessionStorage.getItem('搜索关键词'), "_blank");
																							}
																						} catch (err) {}
																					}, 123);
																					...
																					setTimeout(function() {
																						try {
																							window.open('https://www.jiaomh.com/search.php?searchword=' + sessionStorage.getItem('搜索关键词'), '_blank');
																						} catch (err) {}
																					}, 123);
																					...
																					setTimeout(function() {
																						try {
																							window.open('https://miao101.com/search?q=' + sessionStorage.getItem('搜索关键词'), '_blank');
																						} catch (err) {}
																					}, 123);
																...
																if (https[num].json == null || https[num].json == undefined || https[num].json == '' || https[num].json == '0' || https[num].json.match(new RegExp("(?:跳|窗|^\s*?(?<!开)关\s*?$)")) || localStorage.getItem("objjbo") != '1') {
																	...
																	if (https[num].vip == null || https[num].vip == undefined || https[num].vip == '' || !https[num].vip.match(new RegExp("(?:跳|窗)"))) {
																		...
																		if (document.querySelector(vip)) {
																			document.querySelector(vip).innerHTML = '<div id="江小白" ' + jxbvipjxidstyle + '><div style="letter-spacing:2px;color:#f8964c;' + jxbvipjxstrongstyle + '><strong>江</strong><strong>小</strong><strong>白</strong></div></div>';
																			setTimeout(() => {
									...
									if (jxbpcobj) {
										...
										try {
											...
											try {
												...
												sjqjpbzdylwaobj = /(?:地衣|学习|爱酷|[教文方学]案|PAR|柚子|宝莲|古思|暮光|口袋|专享|沐白|达人)/i, sjyyyzdypbobj = /(?:地衣|吾吾|爱跟|年报|老版|达人|[淘白][a-z0-9]|扫描|月亮|看剧|神马|酷看|久播|思[云念]|速云)/i, sjqjpbzdylwbobj = /(?:猪蹄|七彩|刺客|扫描|神马|金鸡|白玉|依托|法克|垫片|依齐|江湖|乐多|思古|[三八][一二]|17云|1717|8090|哔哩|九八|CKP|OK|Youtube|和巴|[方文学提教]案|透明无接口)/i;
														...
														if (document.querySelector('div.maomibtn')) {
															...
															try {
																if ((document.querySelector('iframe[src^="http"][src*="=http"][allowfullscreen]:not([style*="display:none"]):not([style*="display: none"])').src.match(jxjkwzobj)) && document.querySelector('iframe[src^="http"][src*="=http"][allowfullscreen]:not([style*="display:none"]):not([style*="display: none"])').getAttribute('id') != '\u6c5f\u5c0f\u767d') {
																	...
																	if ((document.querySelector("div#\u6c5f\u5c0f\u767d>div>strong:first-child").innerText.match(/^[\u6c5f\u89e3\u5907]$/)) && (document.querySelector("div#\u6c5f\u5c0f\u767d>div>strong:last-of-type").innerText.match(/^[\u767d\u8d25\u6790]$/))) {} else {
																		try {
																			window.close();
																		} catch (err) {
																			zdpddyobj();
											...
											function zdssspc() {
												try {
													if (pcliwaiobj) {
														(function() {
															try {
																location.href = document.querySelector('div.maomibtn>ul>li>ul>li>a[href*="//www.jiaomh.com"]').href;
															} catch (err) {
																return false;
															}
														})();
