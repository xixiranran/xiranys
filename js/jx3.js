...
(function () {
    ...
    var originalInterfaceList = [
        ...
        //----------------------------------------------------------------------------------------
        {name:"纯净/B站",type:"0",url:"https://z1.m1907.cn/?jx="},
        {name:"综合/B站1",type:"0",url:"https://vip.parwix.com:4433/player/?url="},
    ...
    GMaddStyle(`#vip_movie_box {cursor:pointer; position:fixed; top:` + top + `px; left:` + left + `px; width:29px; background-color:#FF4500; z-index:2147483647; font-size:12px; text-align:left;}
                ...
                #vip_movie_box .vip_mod_box_selected li{font-size:16px; color:#DCDCDC; text-align:center; width:40px; line-height:27px; float:left; border:1px dashed gray; padding:0 4px; margin:2px 2px;}
                #vip_movie_box .vip_mod_box_selected li:hover{color:#FF4500; background-color:#000000;}
                #vip_movie_box .vip_mod_box_selected .selected{color:#FF4500; background-color:#000000; border:1px solid gray;}`);
    ...
    var html = $(`<div id='vip_movie_box'>
                    ...
                    <div class='selected_text' >
                       ...
                       <div class='vip_mod_box_selected' >
                         <div style='display:flex;'>
                            <div style='width:316px; padding:10px 0;'>
                              <div style='font-size:13px; text-align:center; color:#FFFFFF; line-height:21px;margin-bottom:2px;'>视频列表</div>
