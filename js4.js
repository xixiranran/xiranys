...
(function(){
    ...
    function addDiv(){
        ...
        var css = "position:fixed;top:160px;left:3px;z-index:9999999999999999999999999999;width:60px;height:30px;line-height:30px;text-align:center;font-size:18px;font-family:Verdana, Arial, '宋体';font-weight:700;color:#f00;user-select:none;padding:0px;white-space:nowrap;border:3px solid #f00;cursor:pointer;";
